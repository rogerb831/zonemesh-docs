...
<CodeBlock filename="route53-source-config.json">
{`{
...
<Callout type="tip">
Route 53 is a global service, but API calls require a region. Use the region closest to your hub location.
</Callout>
...
<CodeBlock filename="axfr-source-config.json">
{`{
  "masterIp": "192.0.2.1",
  "port": 53,
...
Ensure your master DNS server allows zone transfers from your hub's IP address. TSIG authentication is optional but recommended for security.
</Callout>
